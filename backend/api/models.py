...
class Video(models.Model):
    ...
    def generate_thumbnail(self):
        ...
        try:
            ...
            # Use ffmpeg to extract a frame at 3 seconds
            print("Extracting thumbnail at 3 seconds")
            cmd = [
                'ffmpeg',
                '-i', temp_video_path,
                '-ss', '00:00:03',  # Extract frame at 3 seconds
                '-vframes', '1',
            ...
            if os.path.exists(temp_thumb_path) and os.path.getsize(temp_thumb_path) > 100:
                ...
                print(f"Failed to generate thumbnail at 3 seconds: file missing or too small")
                return False
