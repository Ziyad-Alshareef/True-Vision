                    ...
                    <div className={`${isDarkMode ? 'bg-neutral-900' : 'bg-white'} rounded-lg p-8 shadow-lg`}>
                        ...
                        <div className={`space-y-6 ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>
                            ...
                            <section>
                                ...
                                <p>
                                    We implement appropriate technical and organizational measures to protect your data against unauthorized access, alteration, disclosure, or destruction. All uploaded videos are processed securely and deleted after analysis.
                                </p>
                            </section>
